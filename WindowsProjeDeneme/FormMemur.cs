...
{
    public partial class FormMemur : KullaniciBaseForm.KullaniciBaseForm
    {
         Form pForm;
        public FormMemur(Form form)
        {
            InitializeComponent();
            pForm = form;
        }
        ...
        private void FormMemur_FormClosing(object sender, FormClosingEventArgs e)
        {
            if(flag==false)
            Application.Exit();
        }
